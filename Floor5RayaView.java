...
public class Floor5RayaView extends JFrame {
    private final Floor5RayaModel model;
    private Floor5RayaController controller;
    ...
    public Floor5RayaView(Floor5RayaModel model, Floor5RayaController controller) {
        this.model = model;
        this.controller = controller;
        setTitle("Floor 5 - Raya Lucaria Academy");
        initializeView();
        updateView();
    }
    ...
    public void setController(Floor5RayaController controller) {
        this.controller = controller;
    }
