...
public class Floor1EldenView extends JFrame {
    private final Floor1EldenModel model;
    private final Floor1EldenController controller;
    ...
    public Floor1EldenView(Floor1EldenModel model, Floor1EldenController controller) {
        this.model = model;
        this.controller = controller;
        setTitle("Floor 1 - Elden Throne");
        initializeView();
        updateView();
    }
