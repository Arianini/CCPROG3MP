...
public class Floor2EldenView extends JFrame {
    private final Floor2EldenModel model;
    private Floor2EldenController controller;
    ...
    public Floor2EldenView(Floor2EldenModel model, Floor2EldenController controller) {
        this.model = model;
        this.controller = controller;
        setTitle("Floor 2 - Elden Throne");
        initializeView();
        updateView();
    }
    ...
    public void setController(Floor2EldenController controller) {
        this.controller = controller;
    }
