...
public class Floor3RayaView extends JFrame {
    private final Floor3RayaModel model;
    private Floor3RayaController controller;
    ...
    public Floor3RayaView(Floor3RayaModel model, Floor3RayaController controller) {
        this.model = model;
        this.controller = controller;
        setTitle("Floor 3 - Raya Lucaria Academy");
        initializeView();
        updateView();
    }
    ...
    public void setController(Floor3RayaController controller) {
        this.controller = controller;
    }
