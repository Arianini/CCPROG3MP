...
public class Floor3EldenView extends JFrame {
    private final Floor3EldenModel model;
    private Floor3EldenController controller;
    ...
    public Floor3EldenView(Floor3EldenModel model, Floor3EldenController controller) {
        this.model = model;
        this.controller = controller;
        setTitle("Floor 3 - Elden Throne");
        initializeView();
        updateView();
    }
        ...
        for (int i = 0; i < model.getRows(); i++) {
            for (int j = 0; j < model.getColumns(); j++) {
                ...
                if (tile instanceof FastTravelTile) {
                    ...
                    tileLabel.setText(tile.hasPlayer() ? "P" : "C");
    ...
    public void setController(Floor3EldenController controller) {
        this.controller = controller;
    }
