...
public class Floor3StormView extends JFrame {
    private final Floor3StormModel model;
    private Floor3StormController controller;
    ...
    public Floor3StormView(Floor3StormModel model, Floor3StormController controller) {
        this.model = model;
        this.controller = controller;
        setTitle("Floor 3 - Stormveil Castle");
        initializeView();
        updateView();
    }
    ...
    public void setController(Floor3StormController controller) {
        this.controller = controller;
    }
