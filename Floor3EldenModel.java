public class Floor3EldenModel extends EldenThroneFloor {
    private Tile[][] tiles;
    private CharacterModel characterModel;
    
    public Floor3EldenModel() {
        super(9, 3, 8, 1, "Elden Throne"); // 5 rows, 5 columns, player starts at (6,1)
        initializeTiles();
    }
    ...
    private void initializeTiles() {
        ...
        tiles[0][1] = new CreditsTile();
        tiles[8][1] = new DoorTile();
        ...
        tiles[7][0] = new SpawnTile();
        tiles[7][2] = new SpawnTile();
    ...
    public void movePlayer(int newRow, int newColumn) {
        if (newRow >= 0 && newRow < rows && newColumn >= 0 && newColumn < columns) {
            ...
            if (currentTile instanceof PlayerTile && currentTile.hasPlayer()) {
                 if (playerRow == 0 && playerColumn == 1) {
                    tiles[playerRow][playerColumn] = new CreditsTile();
                 } else if (playerRow == 8 && playerColumn == 1) {
                    tiles[playerRow][playerColumn] = new DoorTile();
                 } else if ((playerRow == 1 && playerColumn == 0) || (playerRow == 1 && playerColumn == 2) || (playerRow == 3 && playerColumn == 0) || (playerRow == 3 && playerColumn == 2) || (playerRow == 5 && playerColumn == 0) || (playerRow == 5 && playerColumn == 2) || (playerRow == 7 && playerColumn == 0) || (playerRow == 7 && playerColumn == 2)) {
                ...
                if (!(destinationTile instanceof CreditsTile) && !(destinationTile instanceof FastTravelTile) && !(destinationTile instanceof DoorTile) && !(destinationTile instanceof SpawnTile)) {
                    tiles[playerRow][playerColumn] = new PlayerTile();
                }
            }
        }
