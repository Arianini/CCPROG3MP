...
public class Floor2StormView extends JFrame {
    private final Floor2StormModel model;
    private Floor2StormController controller;
    ...
    public Floor2StormView(Floor2StormModel model, Floor2StormController controller) {
        this.model = model;
        this.controller = controller;
        setTitle("Floor 2 - Stormveil Castle");
        initializeView();
        updateView();
    }
    ...
    private JPanel createPlayerStatsPanel() { //may prob
    ...
    public void setController(Floor2StormController controller) {
        this.controller = controller;
    }
}